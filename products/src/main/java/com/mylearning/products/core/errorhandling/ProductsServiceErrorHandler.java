...
public class ProductsServiceErrorHandler{
    ...
    public ResponseEntity<Object> handleIlegalStateException(IllegalStateException ex, WebRequest request)
    {
    ...
    public ResponseEntity<Object> handleIOtherException(Exception ex, WebRequest request)
    {
        ErrorMessage errorMessage = new ErrorMessage( new Date(),ex.getMessage());
        return new ResponseEntity<>(errorMessage, new HttpHeaders(), HttpStatus.INTERNAL_SERVER_ERROR);
    }
